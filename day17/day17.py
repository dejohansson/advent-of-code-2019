...
def param_sum(s_map):
    ...
    for i, line in enumerate(lines):
        for j, col in enumerate(line):
            try:
                if col == "#" and lines[i+1][j] == "#" and lines[i-1][j] == "#" and lines[i][j+1] == "#" and lines[i][j-1] == "#":
                    sum += i*j
            except IndexError:
                pass
    return sum
